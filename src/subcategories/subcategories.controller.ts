import { Controller, Put, Param, Body, Post, HttpCode, HttpStatus, UseInterceptors, UploadedFile, Get } from '@nestjs/common';
...
export class SubCategoriesController extends BaseController<SubCategoryDocument> {
    ...
    async update(
        ...
        const data = await this.subCategoriesService.update(id, updateSubCategoryDto);
